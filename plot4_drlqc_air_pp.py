...
if __name__ == "__main__":
    ...
    if args.use_lambda:
        path = "./results/{}_{}/finite/multiple/DRLQC/params_lambda/air/".format(args.dist, args.noise_dist)
        rawpath = "./results/{}_{}/finite/multiple/DRLQC/params_lambda/air/raw/".format(args.dist, args.noise_dist)
    else:
        path = "./results/{}_{}/finite/multiple/DRLQC/params_thetas/air/".format(args.dist, args.noise_dist)
        rawpath = "./results/{}_{}/finite/multiple/DRLQC/params_thetas/air/raw/".format(args.dist, args.noise_dist)
