...
def summarize(out_lq_list,  out_drce_list, dist, noise_dist, path, num,  plot_results=True):
    ...
    plt.plot(traj_lqr_list[0][0, :], traj_lqr_list[0][2, :], '--', label='Desired Curvy Trajectory', color='black', linewidth=2)
...
if __name__ == "__main__":
    ...
    if args.use_lambda:
        path = "./results/{}_{}/finite/multiple/params_lambda/2d/".format(args.dist, args.noise_dist)
        rawpath = "./results/{}_{}/finite/multiple/params_lambda/2d/raw/".format(args.dist, args.noise_dist)
    else:
        path = "./results/{}_{}/finite/multiple/params_thetas/2d/".format(args.dist, args.noise_dist)
        rawpath = "./results/{}_{}/finite/multiple/params_thetas/2d/raw/".format(args.dist, args.noise_dist)
    ...
    summarize(lqg_data, drce_data, args.dist, args.noise_dist,  path , args.num_sim, plot_results=True)
