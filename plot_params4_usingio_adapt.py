...
if __name__ == "__main__":
    ...
    if args.use_lambda:
        path = "./results/{}_{}/finite/multiple/DRLQC/params_lambda/ioadapt/".format(args.dist, args.noise_dist)
        rawpath = "./results/{}_{}/finite/multiple/DRLQC/params_lambda/ioadapt/raw/".format(args.dist, args.noise_dist)
    else:
        path = "./results/{}_{}/finite/multiple/DRLQC/params_thetas/ioadapt/".format(args.dist, args.noise_dist)
        rawpath = "./results/{}_{}/finite/multiple/DRLQC/params_thetas/ioadapt/raw/".format(args.dist, args.noise_dist)
    ...
    if args.dist=='normal':
        ...
        theta_v_list = [ 2.0,  4.0, 6.0, 8.0]
        theta_w_list = [2.0,  4.0,  6.0]
    else:
