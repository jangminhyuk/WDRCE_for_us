...
if __name__ == "__main__":
    ...
    if args.use_lambda:
        path = "./results/{}_{}/finite/multiple/params_lambda/vehicle_io/".format(args.dist, args.noise_dist)
    else:
        path = "./results/{}_{}/finite/multiple/params_thetas/vehicle_io/".format(args.dist, args.noise_dist)
